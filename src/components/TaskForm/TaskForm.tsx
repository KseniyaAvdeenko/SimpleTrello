...
const TaskForm: FC<ITaskFormProps> = ({taskArrayLength, isOpen, setIsOpen, taskList}) => {
    const dispatch = useAppDispatch();
    const [closeBtnFill, setCloseBtnFill] = useState<string>('#345e37')
    ...
    function onSubmitHandler(e: React.FormEvent<HTMLFormElement>) {
        ...
        dispatch(createTask({
            ...
            order: taskArrayLength + 1
        }))
        setNewTaskTitle('')
    }

    return (
        <form onSubmit={e => onSubmitHandler(e)} data-list={taskList.taskListId}
              className={isOpen ? [styles.task__form, styles.task__form_open].join(' ') : styles.task__form}>
            ...
            <div className={styles.btnContainer}>
                <button type="submit" className={styles.taskList__button}>+ add task</button>
